...
/***/ function(module, exports, __webpack_require__) {
	...
	
	{
		...
		var Fruit = React.createClass({
			...
			setAlertState: function setAlertState() {
				...
				this.props.items.map(function (item) {
					return alert[item.type] = state;
				});
	
				return alert;
			},
			alertColor: function alertColor(type) {
			...
			itemsState: function itemsState() {
	
				var alert = this.state.alert;
				var keys = Object.keys(this.state.alert);
				var active = true;
				...
				return React.createElement(
					...
					React.createElement(
						...
						this.props.items.map(function (item, id) {
							...
							var alertState = _this.state.alert;
							var alertClass = alertState[item.type] ? 'fruit__item--alert' : '';
							...
							return React.createElement(
								'li',
								{
									...
									onClick: _this.alertColor.bind(_this, item.type)
								},
								item.type
							);
						})
		...
		ReactDOM.render(React.createElement(Fruit, { items: items }), document.getElementById('app'));
	}
